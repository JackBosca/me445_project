function err = obj_cl_partial(params, alpha, cl, err_type)
% obj_cl_partial - Objective function for the Joukowski profile cl error 
% minimization problem, considering xi and a.
% 
% INPUTS: 
