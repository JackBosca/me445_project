function err = obj_geom_eta(eta, xi, a, x, y, err_type)
% obj_geom_eta - Objective function for the Joukowski profile geometric 
% error minimization problem with xi_origin, a being fixed.
% 
% INPUTS: 
% - eta, float: eta coordinate of the circle origin
% - xi, float: xi coordinate of the circle origin
...
%               Changes: release.
    ...
    [~, xj, yj] = joukowski_transform([eta, xi, a]);
